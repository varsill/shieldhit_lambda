...
input_results_dump = input_results_dump[input_results_dump[f"params.{args.group_by_param}"]>lower_limit]
input_results_dump = input_results_dump[input_results_dump[f"params.{args.group_by_param}"]<upper_limit]
args.title = "\n".join(wrap(args.title))
if operation == "histogram":
  plot_request_times_histogram(input_results_dump, args.group_by_param, plot_filename, metric=args.metric, group_by_param_value=args.group_by_param_value, title=args.title)

elif operation == "simulation_to_request":
  plot_simulation_time_to_request_time_vs_param(input_results_dump, args.group_by_param, plot_filename, workers=args.workers, title=args.title)
  ...
  plot_map_reduce_total_time_vs_params(input_results_dump, args.group_by_param, plot_filename, fields_list, title=args.title)

elif operation == "distribution":
  plot_distribution(input_results_dump, args.group_by_param, plot_filename, title=args.title)

elif operation == "cumulative_times":
  plot_cumulative_time_vs_params(input_results_dump, args.group_by_param, plot_filename, workers=args.workers, title=args.title)

elif operation == "speedup":
  plot_speedup(input_results_dump, args.group_by_param, plot_filename, title=args.title)